  ...
  //   var skill1="";
    ...
    $(".wraper").on("click",".delete", function(e){
        ...
        $.ajax({
          ...
          cache:false,
          beforeSend:function(){
            $(".AddNewEmployee").html("<img src='../model/img/loader.gif' style='width:3%;'> Uploading Data....");
          },
          success:function(e){
            console.log(e);
	...
	function deleteEmployee(deleteEmployeeId){
        ...
        cache:false,
        beforeSend:function(){
          $(".asap_remove_employee"+deleteEmployeeId).html("<img src='../model/img/loader.gif' style='width:3%;'> removing Data....");
        },
        success:function(e){
          if(e.length>2){
	...
	function deleteFuntion(skill_id_delete){
        ...
        cache:false,
        beforeSend:function(){
          $(".asap_remove"+skill_id_delete).html("<img src='../model/img/loader.gif' style='width:3%;'> Removing Data....");
        },
        success:function(e){
          if(e.length>2){
